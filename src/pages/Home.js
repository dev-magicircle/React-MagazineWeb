        ...
        <div class="sticky-header fixed d-lg-none d-md-block">
            <div class="text-right">
                <div class="container mobile-menu-fixed pr-5"> 
                    <h1 class="logo-small navbar-brand"><a href="index.html" class="logo"><img src="assets/images/logo.png" alt=""/></a></h1>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <article class="first mb-3">
                                            <figure><a href="single.html"><img src="http://via.placeholder.com/1240x700" alt="post-title"/></a></figure>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <article class="post-has-bg">
                                            <div class="mb-3 d-flex row">
                                                <figure class="col-4 col-md-4"><a href="single.html"><img src="http://via.placeholder.com/512x700" alt="post-title"/></a></figure>
                                                <div class="entry-content col-8 col-md-8 pl-md-0">                                                    
                                                    <h5 class="entry-title mb-3"><a href="single.html">The Night My Doorbell Camera Captured a Shooting</a></h5>
                                                    <div class="entry-meta align-items-center">
                                        ...
                                        <article>
                                            <div class="mb-3 d-flex row">
                                                <figure class="col-4 col-md-4"><a href="single.html"><img src="http://via.placeholder.com/512x512" alt="post-title"/></a></figure>
                                                <div class="entry-content col-8 col-md-8 pl-md-0">
                                                    <h5 class="entry-title mb-3"><a href="single.html">Privacy Is Just the Beginning of the Debate Over Tech</a></h5>
                                                    <div class="entry-meta align-items-center">
                                            ...
                                            <div class="mb-3 d-flex row">
                                                ...
                                                <div class="entry-content col-8 col-md-8 pl-md-0">
                                                   <div class="capsSubtle mb-2">based on your reading history</div>
                                                    <h5 class="entry-title mb-3"><a href="single.html">Want To Make Millions? Then Act Like a Millionaire</a></h5>
                                                    <div class="entry-meta align-items-center">
          ...
          {/* <div class="content-widget">
                    <div class="container">
                        <div class="row justify-content-between post-has-bg ml-0 mr-0">
                            ...
                            <div class="col-lg-6 col-md-4 bgcover d-none d-md-block pl-md-0 ml-0" style={{backgroundImage:"url("+"http://via.placeholder.com/800x495"+")"}}></div>
                        </div>
                        <div class="divider"></div>
                    </div>
                </div>  */}
                            ...
                            <div class="col-md-10">
                                <div class="row justify-content-between">
                                    <article class="col-md-6">
                                        <div class="mb-3 d-flex row">
                                            <figure class="col-md-5"><a href="single.html"><img src="http://via.placeholder.com/512x512" alt="post-title"/></a></figure>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <article class="row justify-content-between mb-5 mr-0">
                                    ...
                                    <div class="col-md-3 bgcover" style={{backgroundImage:"url("+"http://via.placeholder.com/800x495"+")"}}></div>
                                </article>
                                <article class="row justify-content-between mb-5 mr-0">
                                    <div class="col-md-9 ">
                                        <div class="align-self-center">
                                    ...
                                    <div class="col-md-3 bgcover" style={{backgroundImage:"url("+"http://via.placeholder.com/512x512"+")"}}></div>
                                </article>
                                <article class="row justify-content-between mb-5 mr-0">
                                    <div class="col-md-9 ">
                                        <div class="align-self-center">
                                    ...
                                    <div class="col-md-3 bgcover" style={{backgroundImage:"url("+"http://via.placeholder.com/51x512"+")"}}></div>
                                </article>
                                <article class="row justify-content-between mb-5 mr-0">
                                    <div class="col-md-9 ">
                                        <div class="align-self-center">
