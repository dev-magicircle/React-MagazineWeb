                  ...
                  <div class="col-md-8">
                    ...
                    <article class="row justify-content-between mb-5 mr-0">
                      ...
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(" + "http://via.placeholder.com/800x495" + ")",
                        }}
                      ></div>
                    </article>
                    <article class="row justify-content-between mb-5 mr-0">
                      ...
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(" + "http://via.placeholder.com/512x512" + ")",
                        }}
                      ></div>
                    </article>
                    <article class="row justify-content-between mb-5 mr-0">
                        ...
                        <div class="align-self-center">
                          ...
                          <div class="entry-excerpt">
                            <p>
                              ...
                              you don’t want to do and getting uncomfortable on
                              a daily basis.
                            </p>
                          </div>
                          <div class="entry-meta align-items-center">
                            <a href="author.html">Azimi Ókalo</a> in{" "}
                    ...
                    <article class="row justify-content-between mb-5 mr-0">
                      <div class="col-md-9 ">
                        <div class="align-self-center">
                          ...
                          <div class="entry-excerpt">
                            <p>
                              At WWDC, Apple debuted a slew of new features that
                              let users connect with their families and friends
                              right inside Apple’s apps — no social.
                            </p>
                          </div>
                          <div class="entry-meta align-items-center">
